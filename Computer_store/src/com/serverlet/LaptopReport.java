...
/**
 * Servlet implementation class LaptopReport
 */
@WebServlet("/LaptopReport")
public class LaptopReport extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			jasperDesign = JRXmlLoader.load(path + "/LaptopReport.jrxml");
