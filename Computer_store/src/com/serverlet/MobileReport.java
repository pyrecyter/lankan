...
/**
 * Servlet implementation class MobileReport
 */
@WebServlet("/MobileReport")
public class MobileReport extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			jasperDesign = JRXmlLoader.load(path + "/MobileReport.jrxml");
