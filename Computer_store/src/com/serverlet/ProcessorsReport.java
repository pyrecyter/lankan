...
/**
 * Servlet implementation class ProcessorsReport
 */
@WebServlet("/ProcessorsReport")
public class ProcessorsReport extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			jasperDesign = JRXmlLoader.load(path + "/ProcessorsReport.jrxml");
