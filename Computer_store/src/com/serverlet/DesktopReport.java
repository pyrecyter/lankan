...
/**
 * Servlet implementation class DesktopReport
 */
@WebServlet("/DesktopReport")
public class DesktopReport extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			jasperDesign = JRXmlLoader.load(path + "/DesktopReport.jrxml");
