...
/**
 * Servlet implementation class PrinterReport
 */
@WebServlet("/PrinterReport")
public class PrinterReport extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			jasperDesign = JRXmlLoader.load(path + "/PrinterReport.jrxml");
