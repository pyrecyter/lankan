...
/**
 * Servlet implementation class CCTVReport
 */
@WebServlet("/CCTVReport")
public class CCTVReport extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			jasperDesign = JRXmlLoader.load(path + "/CCTVReport.jrxml");
