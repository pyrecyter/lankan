...
/**
 * Servlet implementation class NetworkReport
 */
@WebServlet("/NetworkReport")
public class NetworkReport extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			jasperDesign = JRXmlLoader.load(path + "/NetworkReport.jrxml");
