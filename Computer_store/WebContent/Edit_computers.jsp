...
<html lang="en">
  ...
  <body id="page-top" onload="document.getElementById('select').value='<%=type%>'">
    ...
    <h1>Computers</h1><br><br>
      ...
      <div class="card mb-3">
            <div class="card-header">
              ...
              Edit</div>
            <div class="card-body">
             <form class="form" action="Update_computers" method="post">
 
        <div class="form__group">
            ID: <input type="hidden" placeholder="Name" name="id" class="form-control" value ="<%=id%>" />
            <input type="text" placeholder="Name" class="form-control" value ="<%=id%>" disabled />
        </div>
        
        <div class="form__group">
            Computers Name: <input type="text" placeholder="Name" name="Name" class="form-control" required value="<%=name%>"  />
        </div>
                
         <div class="form__group">
            Content: <textarea  name="Content"  class="form-control" required><%=content%></textarea>
        </div>
        
         <div class="form__group">
            Price: <input type="text" placeholder="LKR" name="Price" class="form-control" required value="<%=price%>"/>
        </div>
