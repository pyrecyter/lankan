...
try{
	 ...
	 String sql ="select * from computers where id='"+idcomputer +"';";
...
%>
          <div class="card mt-4">
            <img class="card-img-top img-fluid" src="images/Desktop/<%=filename%>" height = "100" alt="">
            <div class="card-body">
              ...
              <div class="card-footer">
                ...
                <input type="hidden" name="id" value=<%=idcomputer%>>
                <input type="hidden" name="prefix" value="computers">
                <input type="submit" value="+wishlist" class="btn">
                </form><%} %>
                  <div class="icon-cart" style="float: right;">
                   <div class="container">
                   <a href="Compare_Desktop.jsp?id=<%=idcomputer%>" class ="btn btn-info">Compare</a>
                   <%if ((session.getAttribute("Email") != null)) { %>
