        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            ...
            <div class="table-responsive">
               <form class="btn btn-info" action="QuoReport" method="get">
...
%>
                   ...
                   <tbody>
                    <tr>
                      <td><%=resultSet.getString("itemname1") %></td>
                      <td><%=resultSet.getString("quantity1") %></td>
                      <td><%=resultSet.getString("itemname2") %></td>
                      <td><%=resultSet.getString("quantity2") %></td>
                      <td><%=resultSet.getString("itemname3") %></td>
                      <td><%=resultSet.getString("quantity3") %></td>
                      <td><%=resultSet.getString("itemname4") %></td>
                      <td><%=resultSet.getString("quantity4") %></td>
                      <td><%=resultSet.getString("name") %></td>
                      <td><%=resultSet.getString("email") %></td>
                      
                      <td><a href="Delete_Quote.jsp?email=<%=resultSet.getString("email") %>"><button type="button" class="delete">Delete</button></a></td>
