...
<html lang="en">
  ...
  <head>
<%
String idnetwork=request.getParameter("idnetwork");
    ...
    <h1>CCTV</h1><br><br>
      ...
      <div class="card mb-3">
            ...
            <div class="card-body">
             ...
             <form class="form" action="Update_network" method="post" enctype="multipart/form-data">
 
        <div class="form__group">
            ID: <input type="text" value="<%=request.getParameter("idnetwork")%>" placeholder="<%=request.getParameter("idnetwork")%>" name="id" class="form-control" required readonly />
        </div>
