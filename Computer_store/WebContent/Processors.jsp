          ...
          <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
			...
			<div class ="container">
				<table class="table">
					<tbody>
					<tr>
						<td><a href="ProcessorsView.jsp?processors=Intel"><img src="images/Processors/frontend/intel.png" width="300" height="120"></a></td>
						<td><a href="ProcessorsView.jsp?processors=AMD"><img src="images/Processors/frontend/amd.png" width="300" height="120"></a></td>
					</tr>
					<tr>
						<td><a href="ProcessrosView.jsp?processors=Qualcomm"><img src="images/Processors/frontend/qual.png"width="300" height="120"></a></td>
						<td><a href="ProcessorsView.jsp?processors=Nvidia"><img src="images/Processors/frontend/nvidia.png"width="300" height="120"></a></td>
					</tr>
					<tr>
						<td><a href="ProcessorsView.jsp?processors=IDM"><img src="images/Processors/frontend/IDM.png"width="300" height="120"></a></td>
						<td><a href="ProcessorsView.jsp?processors=Samsung"><img src="images/Processors/frontend/samsung.png"width="300" height="120"></a></td>
					</tr>
