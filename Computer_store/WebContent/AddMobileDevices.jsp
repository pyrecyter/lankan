    ...
    <h1>Mobile Devices</h1><br><br>
      ...
      <div class="card mb-3">
            ...
            <div class="card-body">
             ...
             <form class="form" action="Add_mobile" method="post" enctype="multipart/form-data">
        <div class="form__group">
            Mobile Name: <input type="text" placeholder="Name" name="Name" class="form-control" required  />
        </div>
       ...
       <input type="submit" value="ADD" class="btn" onclick="allnumeric(Price)" >
