...
%>
        <div class="col-lg-4 mb-4">
          <div class="card h-100">
            ...
            <div class="card-body">
              <div class="display-4"><a href="Laptop_Item.jsp?id=<%=resultSet.getString("id")  %>"><img class="card-img-top" src="images/Laptops/<%=filename%>" height = "300" alt=""/></a></div>
              <br>
...
%>
 ...
 try{
	 connection = DriverManager.getConnection(connectionUrl+database, userid, password);
	 statement= connection.createStatement();
	 String sql ="select * from laptops where id='"+secondid+"';";
	 resultSet = statement.executeQuery(sql);
	 int i=0;
	 while(resultSet.next()){
	 	String filename = resultSet.getString("filename");
%>          
      ...
      <div class="col-lg-4 mb-4">
          <div class="card h-100">
            ...
            <div class="card-body">
              <div class="display-4"><a href="Laptop_Item.jsp?id=<%=resultSet.getString("id")  %>"><img class="card-img-top" src="images/Laptops/<%=filename%>" height = "300" width="100" alt=""/></a></div>
              <br>
               <div class="display-4">LKR <%=resultSet.getString("Price") %></div>
               <%=resultSet.getString("Content") %>
...
%>      
			...
			<tr>
				...
				<td><a href="Compare_Laptops.jsp?id=<%=request.getParameter("id")%>&seconditem=<%=resultSet.getString("id")%>"><%=resultSet.getString("Name") %></a></td>
