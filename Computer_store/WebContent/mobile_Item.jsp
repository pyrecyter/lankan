...
%>
          <div class="card mt-4">
            <img class="card-img-top img-fluid" src="images/Phone/<%=filename%>" height = "100" alt="">
            <div class="card-body">
              ...
              <div class="card-footer">
                ...
                <input type="hidden" name="prefix" value="mobile">
                <input type="submit" value="+wishlist" class="btn">
                </form><%} %>
                  <div class="icon-cart" style="float: right;">
                   <div class="container">
                   <a href="Compare_Phones.jsp?id=<%=id %>" class ="btn btn-info">Compare</a>
                   <%if ((session.getAttribute("Email") != null)) { %>
