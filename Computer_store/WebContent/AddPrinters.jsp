    ...
    <h1>Printers</h1><br><br>
      ...
      <div class="card mb-3">
            ...
            <div class="card-body">
             ...
             <form class="form" action="Add_printers" method="post" enctype="multipart/form-data">
        <div class="form__group">
            Printer Name: <input type="text" placeholder="Name" name="Name" class="form-control" required  />
        </div>
