...
String laptops= request.getParameter("laptops");
...
<html lang="en">
 ...
 try{
	 ...
	 String sql ="select * from laptops where Type='"+laptops+"';";
...
%>
			<thead>
           	...
           	<tbody>
           	<tr>
           		<td><a href="Laptop_Item.jsp?id=<%=resultSet.getString("id")  %>"><img src="images/laptop/<%=filename%>" height = "100" /></a></td>
