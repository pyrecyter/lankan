...
%>
          <div class="card mt-4">
            <img class="card-img-top img-fluid" src="images/CCTV/<%=filename%>" height = "100" alt="">
            <div class="card-body">
              ...
              <div class="card-footer">
                ...
                <input type="hidden" name="prefix" value="cctv">
                <input type="submit" value="+wishlist" class="btn">
                </form><%} %>
                  <div class="icon-cart" style="float: right;">
                   <div class="container">
                   <a href="Compare_CCTV.jsp?id=<%=id %>" class ="btn btn-info">Compare</a>
                   <%if ((session.getAttribute("Email") != null)) { %>
